      ...
      <div className="relative flex flex-col lg:flex-row items-start justify-between gap-10">
        <div className="flex-1">
          ...
          <motion.h1
            ...
            className="text-2xl md:text-3xl text-gray-900 dark:text-white leading-tight"
          >
            <span className="font-bold">Here are other projects</span>
            <span className="font-light"> that may interest you</span>
          </motion.h1>
        </div>
